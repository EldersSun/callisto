...
public class CameraIdBackFragment extends BaseFragment implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    private static final String TAG = "CameraIdBackFragment";
    ...
    protected View initWidgetsViews(LayoutInflater inflater) {
        return inflater.inflate(R.layout.fm_cameraidback_layout, null);
    }

    private Button CameraIdBack_picture, CameraIdBack_Cancel;

    @Override
    protected void initWidgets(View fgView) {
        CameraIdBack_picture = (Button) fgView.findViewById(R.id.CameraIdBack_picture);
        CameraIdBack_Cancel = (Button) fgView.findViewById(R.id.CameraIdBack_Cancel);
        mTextureView = (TextureView) fgView.findViewById(R.id.CameraIdBack_texture);
        mFile = new File(SysSDCardCacheDir.getImgDir().getPath(), AppConfig.getInstance().VERIFICATION_ID_BACK_PHONE);
    }

    @Override
    protected void initEvent() {
        CameraIdBack_picture.setOnClickListener(this);
        CameraIdBack_Cancel.setOnClickListener(this);
        showImgDialog();
    }
...
//                    }
//                }
//                sendMessage(AppConfig.getInstance().VERIFICATION_ID_BACK,mFile.getPath());
//            }
        }
    };
...
//                    unlockFocus();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.CameraIdBack_picture:
                /**
                ...
                if (!isPictureType) {
                    isPictureType = true;
                    takePicture();
                    CameraIdBack_Cancel.setText(R.string.re_picture);
                    CameraIdBack_picture.setText(R.string.ok);
                } else {
                    getActivity().finish();
                }
                break;
            case R.id.CameraIdBack_Cancel:
                if (isPictureType) {
                    /**
                     * 重置拍摄模式
                     */
                    isPictureType = false;
                    unlockFocus();
                    CameraIdBack_Cancel.setText(R.string.cancel);
                    CameraIdBack_picture.setText(R.string.picture);
                } else {
                    getActivity().finish();
                }
                break;
