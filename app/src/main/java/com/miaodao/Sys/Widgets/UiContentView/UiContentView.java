package com.miaodao.Sys.Widgets.UiContentView;
...
public class UiContentView extends LinearLayout {
    ...
    private void iniWidgets(Context context, AttributeSet attrs) {
        ...
        UiContent_TitleImg.setPadding(0, 20, 0, 20);

        UiContent_ContentImg = new ImageView(context);
        UiContent_ContentImg.setPadding(0, 20, 0, 20);
        ...
        UiContent_Input.setOnTouchListener(new OnTouchListener() {
            @Override
    ...
    private void setValueAttributes(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            try {
                 ...
                 */
                String Gracity = ta
                        .getString(R.styleable.UiContentView_uiContentGracity);
     ...
     * 设置title
     */
    public void setTitleVaule(int str) {
        UiContent_Title.setText(str);
    }
