 ...
 *
 * @author callie
 * @version $Id: Money.java, v 0.0.1 2016年09月09日 下午2:43 callie Exp $
 */
public class Money implements Serializable, Comparable<Object> {
    ...
    public String getYuan() {
        String a = getAmount().setScale(currency.getDefaultFractionDigits()).toString();
        return a;
    }
    ...
    public void setAmount(BigDecimal amount) {
        if (amount != null) {
            cent = rounding(amount.movePointRight(currency.getDefaultFractionDigits()), BigDecimal.ROUND_HALF_EVEN);
        }
    }
