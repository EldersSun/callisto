...
public class CameraIdFrontFragment extends BaseFragment implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    private static final String TAG = "CameraIdFrontFragment";
    ...
    protected View initWidgetsViews(LayoutInflater inflater) {
        return inflater.inflate(R.layout.fm_cameraidfront_layout, null);
    }

    private Button CameraIdFront_picture, CameraIdFront_Cancel;

    @Override
    protected void initWidgets(View fgView) {
        CameraIdFront_picture = (Button) fgView.findViewById(R.id.CameraIdFront_picture);
        CameraIdFront_Cancel = (Button) fgView.findViewById(R.id.CameraIdFront_Cancel);
        mTextureView = (TextureView) fgView.findViewById(R.id.CameraIdFront_texture);
        mFile = new File(SysSDCardCacheDir.getImgDir().getPath(), AppConfig.getInstance().VERIFICATION_ID_FRONT_PHONE);
    }

    @Override
    protected void initEvent() {
        CameraIdFront_picture.setOnClickListener(this);
        CameraIdFront_Cancel.setOnClickListener(this);
        showImgDialog();
    }

    private void showImgDialog() {
        final Dialog customViewDialog = new Dialog(getActivity(), R.style.dialog);
        LayoutInflater inflater = getActivity().getLayoutInflater();
        final View layout = inflater.inflate(R.layout.v_dialog_message_front_layout, null);//获取自定义布局
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
                LinearLayout.LayoutParams.MATCH_PARENT);
        layoutParams.setMargins(0, 0, 0, 0);
        customViewDialog.addContentView(layout, layoutParams);
        final Button CameraDialogFront_picture = (Button) layout.findViewById(R.id.CameraDialogFront_picture);

        CameraDialogFront_picture.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                sendMessage(AppConfig.getInstance().VERIFICATION_ID_FRONT, mFile.getPath());
//            }
        }
    };
...
//                        ImageFormat.JPEG, /*maxImages*/2);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.CameraIdFront_picture:
                /**
                ...
                if (!isPictureType) {
                    isPictureType = true;
                    takePicture();
                    CameraIdFront_Cancel.setText(R.string.re_picture);
                    CameraIdFront_picture.setText(R.string.ok);
                } else {
                    getActivity().finish();
                }
                break;
            case R.id.CameraIdFront_Cancel:
                if (isPictureType) {
                    /**
                     * 重置拍摄模式
                     */
                    isPictureType = false;
                    unlockFocus();
                    CameraIdFront_Cancel.setText(R.string.cancel);
                    CameraIdFront_picture.setText(R.string.picture);
                } else {
                    getActivity().finish();
                }
                break;
