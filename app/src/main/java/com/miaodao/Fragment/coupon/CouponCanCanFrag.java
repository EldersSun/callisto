...
public class CouponCanCanFrag extends BaseFragment implements CouponAdapter.IUseCoupon, View.OnClickListener {
    ...
    protected View initWidgetsViews(LayoutInflater inflater) {
        return inflater.inflate(R.layout.fm_can_coupon, null);
    }
    ...
    protected void initWidgets(View fgView) {
        ...
        btnNotUse = (Button) fgView.findViewById(R.id.btn_not_use_can);
        couponAdapter = new CouponAdapter(getActivity(), useCouponFrom);
        couponAdapter.setiUseCoupon(this);
...
//        requestForHttp(GET_COUPON, AppConfig.getInstance().GET_COUPON, coupon);
            ...
            public void onResponse(String response, int id) {
                ...
                try {
                    ...
                    if (couponList == null || couponList.isEmpty()) {
                        ...
                        if ("show".equals(useCouponFrom)) {
                            btnNotUse.setVisibility(View.VISIBLE);
                        }
    ...
    protected void initEvent() {
        btnNotUse.setOnClickListener(this);
    }
    ...
    public void useCoupon(Coupon coupon) {
        this.coupon = coupon;
        EventBus.getDefault().post(this.coupon);
        getActivity().finish();
    }
